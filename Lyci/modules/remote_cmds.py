...
from Lyci.modules.helper_funcs.extraction import extract_user_and_text
...
def rban(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        message.reply_text("I'm not Ban Me Myself, are you crazy?")
        return
...
def rmute(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        message.reply_text("I'm not Mute Me Myself, are you crazy?")
        return
...
def runmute(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        message.reply_text("I'm not Unmute Me Myself, I'm an admin there!")
        return
